...
cetaceans_ocean <- cetaceans %>%
  ...
  dplyr::select(-c(Affiliation, Locality.Detail, Report.Status, Observation.Date.Act.Est, Additional.Identifiers, Year.of.Necropsy, Month.of.Necropsy, Day.of.Necropsy, Date.of.Necropsy, Necropy.Carcass.Fresh.Frozen, Necropsy.Limited.Flag, Latitude.Units, Field.Number, Day.of.Observation, City, Common.Name, Genus, Species, Restrand, How.Observed)) %>%
