...
fit_step_all <- glm.nb(cnt_all ~ 
          MEI + PDO + NPGO + NOI + SST_39 + SST_39_anom + SST_44 + SST_44_anom + Wind_39 + Wind_44 + Upwelling_39 + Upwelling_45 + CBA_North + CBA_South + ENSO_cat + Sard + Anch + Herring + Msquid_N,
...
fit_step_all <- glm.nb(cnt_all ~ 
          MEI + NPGO + PDO + NOI + SST_39 + SST_39_anom + SST_44 + SST_44_anom + Wind_39 + Wind_44 + Upwelling_39 + Upwelling_45 + CBA_North + CBA_South + ENSO_cat + Sard + Anch + Herring + Msquid_N, 
      data = na.omit(monthly_anom_comb))
...
mod_select <- regsubsets(cnt_all ~ 
       MEI + NOI + SST_39_anom + Upwelling_39 + CBA_North + Sard + Herring, 
      data = monthly_anom_comb, nbest = 3)
summary(mod_select)
...
nb <- summary(glm.nb(cnt_all ~ 
          NOI + SST_39_anom + Upwelling_39 + Herring, 
