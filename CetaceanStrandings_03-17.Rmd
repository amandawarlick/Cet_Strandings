...
ggsave(Sex_all_yr_figure_stack, file = "./Figures_nohp/Sex_all_yr_figure_stack.pdf")
...
Sex_all_yr_figure <- 
  ...
  plot_theme(legend.position = 'top')
ggsave(Sex_all_yr_figure, file = "./Figures_nohp/Sex_all_yr_figure.pdf")
...
Sex_all_yr_boxplot <- 
  ...
  plot_theme(legend.position = 'top')
ggsave(Sex_all_yr_boxplot, file = "./Figures_nohp/Sex_all_yr_boxplot.pdf")
...
Sex_all_month_figure <- 
  ...
  xlab("") + ylab("Proportion of Strandings") +
  plot_theme(legend.position = 'top')
ggsave(Sex_all_month_figure, file = "./Figures_nohp/Sex_all_mo_figure.pdf")
...
ggsave(age_sex_all_figure, file = "./Figures_nohp/age_sex_all_figure.pdf")
...
age_sex_table <- write.csv(age_sex_table, file = "./Figures_nohp/age_sex_table.csv", row.names = F)
...
ggsave(all_yr_figure, file = "./Figures_nohp/all_year_figure.pdf")
...
HI_year_figure <- 
  ...
  plot_theme(legend.position = 'top') +
  scale_color_brewer(palette = 'Set1')
ggsave(HI_year_figure, file = "./Figures_nohp/HI_year_figure.pdf")
```
...
#   plot_theme(legend.position = 'top') + 
#   scale_color_brewer(palette = 'Set1')
#ggsave(HI_type_year_figure, file = "./Figures_nohp/HI_type_year_figure.pdf")
...
species_figure <- species_year %>%
  ...
  xlab("") + ylab("Annual Strandings") +
  plot_theme()
ggsave(species_figure, file = "./Figures_nohp/species_figure.pdf")
...
species_year_HI_figure <- 
  ...
  scale_y_continuous(labels = comma) +
  plot_theme()
ggsave(species_year_HI_figure, file = "./Figures_nohp/species_year_HI_figure.pdf")
...
ggsave(species_all_figure, file = "./Figures_nohp/species_all_figure.pdf")
...
ggsave(species_all_figure_stacked, file = "./Figures_nohp/species_all_figure_stacked.pdf")
...
species_HI_figure <- 
  ...
  plot_theme(legend.position = 'top') #+ 
  #scale_color_brewer(palette = 'Set1')
ggsave(species_HI_figure, file = "./Figures_nohp/species_HI_figure.pdf")
...
HI_prev_all_fig <- ggplot(HI_prev, aes(Year.of.Observation, Prop.HI)) +
  ...
  pubfigure_theme(legend.position = 'top')
ggsave(HI_prev_all_fig, file = "./Figures_nohp/HI_prev_all_fig.pdf")
...
ggplot(aes(x = factor(Month.of.Observation), y = sum, fill = Water.Body)) +
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1')
ggsave(monthly_reg_figure, file = "./Figures_nohp/monthly_reg_figure.pdf")
...
ggplot(aes(x = factor(Month.of.Observation), y = sum, fill = Sex)) +
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1')
ggsave(monthly_sex_figure, file = "./Figures_nohp/monthly_sex_figure.pdf")
...
ggsave(monthly_age_figure, file = "./Figures_nohp/monthly_age_figure.pdf")
...
#   plot_theme() #+ 
#   #scale_color_brewer()
# #ggsave(monthly_years_figure, file = "./Figures_nohp/monthly_years_figure.pdf")
...
reg_figure <- ggplot(regplotdata, aes(x = factor(Month.of.Observation), y = cnt, group = Water.Body, col = Water.Body)) +
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1') 
ggsave(reg_figure, file = "./Figures_nohp/reg_figure.pdf")
...
HI_status <- ggplot(monthly_HI_YNCBD, aes(x = factor(Month.of.Observation), y = cnt, fill = Findings.of.Human.Interaction)) +
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1') 
ggsave(HI_status, file = "./Figures_nohp/HI_status.pdf")
...
monthly_HI_figure <- monthly_HI %>%
  ...
  plot_theme() + 
  scale_fill_brewer(palette = 'Set1')
ggsave(monthly_HI_figure, file = "./Figures_nohp/monthly_HI_figure.pdf")
...
#   plot_theme(legend.position = 'top') + 
#   scale_fill_brewer(palette = 'Set1')
# #ggsave(monthly_HI_figure_stacked, file = "./Figures_nohp/monthly_HI_figure_stacked.pdf")
...
ggplot(aes(x = factor(Month.of.Observation), y = sum, fill = Sex)) +
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1')
ggsave(monthly_HI_sex_figure, file = "./Figures_nohp/monthly_HI_sex_figure.pdf")
...
ggplot(aes(x = factor(Month.of.Observation), y = sum, fill = Age.Class)) +
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1')
ggsave(monthly_HI_age_figure, file = "./Figures_nohp/monthly_HI_age_figure.pdf")
...
# #ggsave(monthly_FI_year_figure, file = "./Figures_nohp/monthly_FI_year_figure.pdf")
```
...
monthly_species_figure <- 
  ...
  plot_theme(legend.position = 'top') #+ 
  #scale_color_brewer(palette = 'Set3')
ggsave(monthly_species_figure, file = "./Figures_nohp/monthly_species_figure.pdf")
...
monthly_species_HI_figure <- 
  ...
  plot_theme(legend.position = 'top') + 
  scale_color_brewer(palette = 'Set3')
#ggsave(monthly_species_HI_figure, file = "./Figures_nohp/monthly_species_HI_figure.pdf")
...
monthly_HI_year_figure <- 
  ...
  plot_theme() #+ 
  #scale_color_brewer(palette = 'Set3')
ggsave(monthly_HI_year_figure, file = "./Figures_nohp/monthly_HI_year_figure.pdf")
...
#   plot_theme(legend.position = 'top') + 
#   scale_color_brewer(palette = 'Set3')
# #ggsave(monthly_FI_shot_year_figure, file = "./Figures_nohp/monthly_FI_shot_year_figure.pdf")
...
year_state_boxplot <- 
  ...
  plot_theme(legend.position = 'top') +
  scale_fill_brewer(palette = 'Set1')
ggsave(year_state_boxplot, file = "./Figures_nohp/year_state_boxplot.pdf")
...
ggplot(aes(x = factor(Year.of.Observation), y = cnt, fill = State)) +
  geom_bar(stat = 'identity', position = position_dodge(width = 0.8), width = 0.6) + 
   ...
   plot_theme() + 
   scale_fill_brewer(palette = 'Set1') 
ggsave(all_state_figure, file = "./Figures_nohp/all_state_figure.pdf")
...
ggplot(aes(x = factor(Year.of.Observation), y = cnt, fill = State)) +
  geom_bar(stat = 'identity', position = position_dodge(width = 0.8), width = 0.6) + 
   ...
   plot_theme() + 
   scale_fill_brewer(palette = 'Set1') 
ggsave(HI_state_year_figure, file = "./Figures_nohp/HI_state_year_figure.pdf")
...
state_species_prop_figure <- 
  ...
  plot_theme() + 
   scale_fill_brewer(palette = 'Set1')
ggsave(state_species_prop_figure, file = "./Figures_nohp/state_species_prop_figure.pdf")
...
allWA_bycounty_figure <- ggplot(allWA_bycounty, aes(x = County, y = cnt)) + 
  ...
  plot_theme() + 
  scale_fill_brewer(palette = 'Set1')
ggsave(allWA_bycounty_figure, file = "./Figures_nohp/allWA_bycounty_figure.pdf")
...
WAHI_bycounty_figure <- 
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1') 
#ggsave(WAHI_bycounty_figure, file = "./Figures_nohp/WAHI_bycounty_figure.pdf")
...
allOR_bycounty_figure <- 
  ...
  plot_theme() + 
  scale_fill_brewer(palette = 'Set1')
ggsave(allOR_bycounty_figure, file = "./Figures_nohp/allOR_bycounty_figure.pdf")
...
ORHI_bycounty_figure <- 
  ...
  plot_theme(legend.position = 'top') + 
  scale_fill_brewer(palette = 'Set1')
ggsave(ORHI_bycounty_figure, file = "./Figures_nohp/ORHI_bycounty_figure.pdf")
...
WAcounties_table <- write.csv(bigtable_WA_HI_table, file = "./Figures_nohp/WAcounties_table.csv", row.names = F)
...
ORcounties_table <- write.csv(bigtable_OR_HI_table, file = "./Figures_nohp/ORcounties_table.csv", row.names = F)
```
...
# species_prop_table <- write.csv(species_prop, file = "./Figures_nohp/species_prop_table.csv", row.names = FALSE)
...
age_sex_composition_table <- write.csv(comb_age_sex_comp, file = "./Figures_nohp/age_sex_composition_table.csv", row.names = FALSE)
...
species_age_sex_composition <- write.csv(species_age_sex_composition, file =
                      "./Figures_nohp/species_age_sex_composition.csv", row.names = FALSE)
...
# 
# species_HI_prop_table <- write.csv(species_prop_HI, file = "./Figures_nohp/species_HI_prop_table.csv", row.names = F)
# 
...
#ggsave(allstrands, file = "./Figures_nohp/Maps/allstrands.pdf")
...
#ggsave(WAstrands, file = "./Figures_nohp/Maps/WAstrands.pdf")
...
pugetstrands <- 
 ...
 scale_alpha(range = c(0, 0.3), guide = FALSE) +
  ...
  theme(
    ...
    legend.position = 'top',
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
#ggsave(pugetstrands, file = "./Figures_nohp/Maps/pugetstrands.pdf")
...
allheatmap <- 
  ...
  theme(
    axis.ticks = element_blank(),
    axis.text = element_blank())
#ggsave(allheatmap, file = "./Figures_nohp/Maps/allheatmap.pdf")
...
WAheatmap <- 
  ...
  theme(
    ...
    #axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
#ggsave(WAheatmap, file = "./Figures_nohp/Maps/WAheatmap.pdf")
...
pugetheatmap_water <-
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
# ggsave(pugetheatmap_water, file = "./Figures_nohp/pugetheatmap_water.pdf")
...
ORheatmap <- 
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
ggsave(ORheatmap, file = "./Figures_nohp/Maps/ORheatmap.pdf")
...
#scale_alpha(range = c(0, 0.3), guide = FALSE) +
  ...
  plot_theme(
    ...
    legend.position = 'top',
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
ggsave(HI_type_map, file = "./Figures_nohp/Maps/HI_type_map.pdf")
...
ggsave(HI_heatmap_colors, file = "./Figures_nohp/HI_heatmap_colors.pdf")
...
HI_heatmap_facet <-  
  ...
  theme(
    ...
    panel.border = element_rect(colour = "black", size = 1)) +
  facet_wrap(~ Interaction.Type)
ggsave(HI_heatmap_facet, file = "./Figures_nohp/HI_heatmap_facet.pdf")
...
ggmap(get_map(location = WAbox, source = "osm")) +
  ...
  theme(
    ...
    strip.background = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = 1)) 
ggsave(HI_heatmap_WA_colors, file = "./Figures_nohp/HI_heatmap_WA_colors.pdf")
...
HI_heatmap_WA_facet <-  
  ...
  theme(
    ...
    #panel.border = element_rect(colour = "black", size = 1)) +
  facet_wrap(~ Interaction.Type)
ggsave(HI_heatmap_WA_facet, file = "./Figures_nohp/HI_heatmap_WA_facet.pdf")
...
ggmap(get_map(location = ORbox, source = "osm")) +
  ...
  theme(
    ...
    strip.background = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = 1)) 
ggsave(HI_heatmap_OR_colors, file = "./Figures_nohp/HI_heatmap_OR_colors.pdf")
...
HI_heatmap_OR_facet <-  
  ...
  theme(
    ...
    panel.border = element_rect(colour = "black", size = 1)) +
  facet_wrap(~ Interaction.Type)
ggsave(HI_heatmap_OR_facet, file = "./Figures_nohp/HI_heatmap_OR_facet.pdf")
...
WAheatmap_species_facet <-   
  ...
  theme(
    ...
    panel.border = element_rect(colour = "black", size = 1)) +
  facet_wrap(~ Cetacean.Common.Name)
ggsave(WAheatmap_species_facet, file = "./Figures_nohp/WAheatmap_species_facet.pdf")
...
ORheatmap_species_facet <-   
  ...
  theme(
    ...
    panel.border = element_rect(colour = "black", size = 1)) +
  facet_wrap(~ Cetacean.Common.Name)
ggsave(ORheatmap_species_facet, file = "./Figures_nohp/ORheatmap_species_facet.pdf")
...
WAheatmap_hs <-   
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
ggsave(WAheatmap_hs, file = "./Figures_nohp/Maps/WAheatmap_hs.pdf")
...
WAheatmap_csl <-   
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
ggsave(WAheatmap_csl, file = "./Figures_nohp/Maps/WAheatmap_csl.pdf")
...
WAheatmap_ssl <-   
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
ggsave(WAheatmap_ssl, file = "./Figures_nohp/Maps/WAheatmap_ssl.pdf")
...
WAheatmap_nel <-   
  ...
  theme(
    ...
    axis.text = element_blank(),
    panel.border = element_rect(colour = "black", fill = "NA", size = .5))
ggsave(WAheatmap_nel, file = "./Figures_nohp/Maps/WAheatmap_nel.pdf")
